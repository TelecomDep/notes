...
**Пример Json-файла с данными о сети и геолокации**
```json
"AllCellInfo": [
    {
        "NetworkType": "CellInfoLte",
        "CellIdentity": "138259478",
        "MCC": "250",
        "MNC": "20",
        "PCI": 303,
        "TAC": 17724,
        "Bands": "7",
        "SignalStrength": "RSRP: -93",
        "RSRP": -93,
        "RSRQ": -13,
        "RSSI": -81,
    ...
    {
        "NetworkType": "CellInfoLte",
        "CellIdentity": "268435455",
        "PCI": 163,
        "TAC": 65535,
        "Bands": "7",
        "SignalStrength": "RSRP: -98",
        "RSRP": -98,
        "RSRQ": -15,
        "RSSI": -83,
        "TimingAdvance": 2147483647,
...
"Location": {
    "Latitude": 55.0132929,
    "Longitude": 82.9507357,
    "Altitude": 136.50001525878906,
    "Time": 1773137040920
}
``` -->
...
6. Обновить `README.md`-файл (в репозитории `backend`'а) с описанием вашего проекта. Описание должно состоять из:
...
4. В чем особенность создания вторичного конструктора в языке Kotlin?
5. Что такое `init{}` в классе?
6. Назовите основные положения ООП?
1. Что такое наследование?
2. В каком случае необходимо использовать наследование?
3. Написать программы, реализующую основной класс и класс-наследник (на усмотрение преподавателя).
1. Опишите основные методы жизненного цикла `Activity` в Android?
1. Как приложение на смартфоне (`Android`) **понимает** какой из методов жизненного цикла выполнить?
1. Что такое `Latitude`, `Longitude`, `Altitude`? В чем измеряется? Если ли ограничение значений? Если да, от чего зависит?
2. Что такое `Unix Epoch Time`?
1. Что такое сокет (с точки зрения операционной системы)?
