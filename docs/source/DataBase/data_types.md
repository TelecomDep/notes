...
Следуя по официально [документации](https://www.postgresql.org/docs/current/datatype.html), можно найти основные типы данных, встроенные в `PostgreSQL` по умолчанию.
